...
def main():
    num_formulas = 100    # Number of CNF formulas to generate.
    num_clauses = 200     # Number of clauses in each formula.
    num_literals = 100    # Variables are in the range [1, num_literals].
